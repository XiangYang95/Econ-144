...
setwd("/Users/Lenovo/Desktop/Econ 144/Week 1")
source("//Users/Lenovo/Desktop/Econ 144/Week 1/full_regression_example.R")
...
anova(y1)
step(y1)
ss=leaps::regsubsets(mpg~hp+wt+cyl,method=c("exhaustive"),nbest=3,data=z)
car::subsets(ss,statistic="cp",legend=F,main="Mallows CP",col="steelblue4")
...
text(15,70000,expression(R^2==0.826))
legend(15,100000, c(expression(y[obs]==y[pred]), "Lowess Smoother"), fill =c("red", "black"),cex=1,bty="y")
#----------------------------------------------------------
...
#-----------PLOT EFFICIENCY vs. WEIGHT by MPG--------------
windows()
