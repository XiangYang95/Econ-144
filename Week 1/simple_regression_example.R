...
setwd("/Users/randallr.rojas/Documents/Courses/Econ144/R_Codes")
...
# 6. Plot the Observed vs Predcied Values 
quartz()
...
library(ggplot2)
ggplot(mtcars, aes(y=wt, x=mpg, colour=factor(cyl)))+ stat_smooth(method=lm) + geom_point()
