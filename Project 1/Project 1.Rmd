...
All the models fit the data pretty well, with at least a 0.85 for the R^2. The time for all models are also statistically significant, indicating that time plays a significant role in the data. Among all the models, the quadratic and the linear-log models have the best R^2, which might indicate that they are the best models to fit the data.
