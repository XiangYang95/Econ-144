...
modelfit
plot(modelfit)
#during the short term there is a strong correlation between the square and actual observations, and slowly subsides 
#as time increases from the cross correlation plot
